...
author: Principal Investigator - Zoe Unno, `r params$institution`
...
output: 
  ...
  word_document:
    toc: yes
    toc_depth: 2
    reference_docx: "styles/Base_2013_day3_style.docx"
params:
  institution:
    choices:
...
Zoe Unno, Principal Investigator, `r params$institution`
...
- The J. Bohannan Foundation adheres to the open access and data sharing policies of the 
[Gates Foundation]https://www.gatesfoundation.org/How-We-Work/General-Information/Open-Access-Policy
...
A sample of the `doaj_seal.csv` data set is shown below. The complete data set is available in searchable and browseable format as [Annex 9.1](#annex-table) at the end of the document. 
...
|7| Publisher website (open access) |
...
The Tidyverse package was invented by @R-tidyverse
...
res <- orcid_bio(orcid = "0000-0002-5176-185X")
bio <- res$'0000-0002-5176-185X'$'content'
